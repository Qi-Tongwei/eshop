...
var page = {
	...
	bindEvent : function(){
		...
		$(document).on('click', '.cart-select', function(){
			var $this = $(this),
			// 寻找直接父元素使用.parent()，要定位特定的祖宗元素使用.parents('selector')
	...
	renderCart : function(data){
		...
		// 通知导航的购物车更新数量
		// 这里是使用了被引入模块的方法，所以被引入模块需要暴露出来
		// cart的逻辑中没有使用header的内部方法，
		// header所有的方法都在自己的模块下完成，所以header不用被暴露出来
		nav.loadCartCount();
	},
